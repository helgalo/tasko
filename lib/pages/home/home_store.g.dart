...
mixin _$HomeStore on _HomeStore, Store {
  ...
  late final _$getTasksAsyncAction =
      AsyncAction('_HomeStore.getTasks', context: context);
  ...
  late final _$logoutAsyncAction =
      AsyncAction('_HomeStore.logout', context: context);
  ...
  void goToDetailsPage(Task task) {
    final _$actionInfo = _$_HomeStoreActionController.startAction(
        name: '_HomeStore.goToDetailsPage');
    try {
  ...
  void onTapCreateTask() {
    final _$actionInfo = _$_HomeStoreActionController.startAction(
        name: '_HomeStore.onTapCreateTask');
    try {
  ...
  void changeIsLoading(bool value) {
    final _$actionInfo = _$_HomeStoreActionController.startAction(
        name: '_HomeStore.changeIsLoading');
    try {
